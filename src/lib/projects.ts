...
export const cardData: CardDataProps[] = [
  ...
  },
  {
    ...
    imageUrl: [
      "/images/projects/myNotebookSignupPage.png",
      "/images/projects/myNotebookLoginPage.png",
      "/images/projects/myNotebookHomePage.png",
      "/images/projects/myNotebookNotes.png",
      "/images/projects/myNotebookEditModal.png",
    ],
  ...
  },
  {
    name: "Portfolio",
    favicon: "/images/projects/Logos/gradient.ico",
    tags: ["Nextjs", "Typescript", "Framer Motion", "Tailwindcss"],
    imageUrl: ["/images/projects/portfolioHomePage.png"],
    description: "Explore my personal portfolio built with Next.js, styled using Tailwind CSS, and animated with Framer Motion. Dive into my projects and experience seamless navigation and dynamic visuals.",
    sourceCodeHref: "https://github.com/Brainstormex/portfolio",
    liveWebsiteHref: "",
  },
];
